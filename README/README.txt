          ...
          Company:        Optiv Security (formerly Accuvant)
...
Prerequisites:
*Splunk 6.3.x, 6.4.x, 6.5.x, or 6.6.x
...
This is an open source project, no support provided, public repository available.
                        https://github.com/ransomvik/optiv_TA_threat
...
c:\Program Files\Splunk\etc\apps\optiv_TA_threat
*Start Splunk
